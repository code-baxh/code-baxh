...
import HeaderData from '../../../data/Careers/Header.json';
...
const Header = () => {
  ...
  return (
    <section className="page-header">
      ...
      <div className="img-wrapper bg-img parallaxie" data-background="/images/careers/img02.jpg" data-overlay-dark="3">
        <div className="title">
          <div className="container">
            <h3>Careers</h3>
          </div>
